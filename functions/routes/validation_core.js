...
function dataExistsAndIsDict(res, package, field_name=null, field_context=null) {
...
module.exports = {
    ...
    assertValidUser: assertValidUser,
    assertValidCoordinate: assertValidCoordinate,
    isNumeric: isNumeric,
    dataExistsAndIsDict: dataExistsAndIsDict,
